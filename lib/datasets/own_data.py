...
class own_data(imdb):
    def __init__(self, image_set, db_name, file_name_list, db_path=None, img_suffix='.jpg'):
        ...
        self._image_ext = img_suffix # e.g. '.jpg'
        # self._image_index = self._load_image_set_index()
        self._image_index = file_name_list
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'own_data')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_own_data_annotation(name)
    ...
    def _load_own_data_annotation(self, name):
        """
